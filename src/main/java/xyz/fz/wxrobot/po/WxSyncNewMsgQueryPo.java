 ...
 */
public class WxSyncNewMsgQueryPo extends WxQueryPo {

    private Logger logger = LoggerFactory.getLogger(WxSyncNewMsgQueryPo.class);

    private String url = "https://wx.qq.com/cgi-bin/mmwebwx-bin/webwxsync";

    public WxSyncNewMsgQueryPo(String urlParams, Map<String, Object> bodyParams) {
